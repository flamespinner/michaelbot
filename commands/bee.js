...
exports.run = (bot, msg, args) => {
    if(msg.author.id != require('../config.json').ownerID) return msg.reply("you are not allowed to do this!") 
        ...
        msg.channel.send("- Hey, Adam.");
        msg.channel.send("- Hey, Barry.");
        msg.channel.send("- Is that fuzz gel?");
        msg.channel.send("- A little. Special day, graduation.");
        msg.channel.send("Never thought I'd make it.");
        msg.channel.send("Three days grade school, three days high school.");
        msg.channel.send("Those were awkward.");
        msg.channel.send("Three days college. I'm glad I took a day and hitchhiked around the hive.");
        msg.channel.send("You did come back different.");
        msg.channel.send("- Hi, Barry.");
        msg.channel.send("- Artie, growing a mustache? Looks good. ");
        msg.channel.send("- Hear about Frankie?");
        msg.channel.send("- Yeah.");
        msg.channel.send("- You going to the funeral?");
        msg.channel.send("- No, I'm not going.");
        msg.channel.send("Everybody knows, sting someone, you die.");
